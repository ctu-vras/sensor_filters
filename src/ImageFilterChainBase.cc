...
void ImageFilterChainBase::initFilters(const std::string& filterChainNamespace, rclcpp::Node::SharedPtr node,
...
void ImageFilterChainBase::subscribe()
{
  this->itSubscriber = this->it->subscribe(
    "input", this->inputQueueSize, [this](const typename sensor_msgs::msg::Image::ConstSharedPtr& msg) {
